...
create or replace directory fotos_dir_viv as '/tmp/bd-unam/proy-final-lobs/VIVIENDAS';

Prompt Creando Objeto Directory para imagenes de iconos de servicio
create or replace directory fotos_dir_icon as '/tmp/bd-unam/proy-final-lobs/ICONOS';

Prompt Otorgando Permisos de lectura
grant read on directory fotos_dir_viv to jp_proy_admin;
grant read on directory fotos_dir_icon to jp_proy_admin;
