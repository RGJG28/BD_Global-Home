...
col vivienda_id format A8
col direccion format A22
col nombre_usuario format A14
col clave format A2
...
Prompt Consulta de usuarios con tarjetas vigentes desde el año 2022 hasta 2024 con algebra relacional y subconsulta en el from
...
from(
    ...
    where tc.anio_exp < 2022
    union
  	select *
      from tarjeta_credito tc
    where tc.anio_exp > 2024
)q, usuario u
